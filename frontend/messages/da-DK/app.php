...
return [
    ...
    '/mo' => '/md',
    'By Certified Bookkeepers Specializing In Small Businesses' => 'Af FFB godkendte revisorer med speciale i små virksomheder',
    ...
    'Using the ClickBooks app simply take photos of your invoices and expenses' => 'Brug eRevisorens App til at tage billeder af dine bilag',
    'A dedicated Bookkeeper will do the work' => 'Din revisor vil håndtere dine bilag',
    'Your ClickBooks bookkeeper will categorize, review and reconcile your books against your bank statements' => 'eRevisoren’s erfarne revisorer vil kategorisere og afstemme din bogføring',
    'Get back to work' => 'Du kan koncentrere dig om dit arbejde',
    'Receive monthly statements and tax-ready financials without having to play an integral role in the bookkeeping process' => 'eRevisoren sender dig løbende rapporter over dine indtægter og udgifter, samt momsregnskaber og årsopgørelse',
    
    'ClickBooks can <b>help you</b>' => 'eRevisoren kan <b>hjælpe dig</b>',
    ...
    'Why Are ClickBooks Bookkeepers So Cheap?' => 'Hvorfor er eRevisoren så billig?',
    'ClickBooks Bookkeeper' => 'eRevisoren ',
    'Paperless' => 'Papirløst',
    'A traditional bookkeepers spends 73% of his time handling paper. And on average each paper is handled 12.6 times.' => 'En traditionel revisor bruger 73% af sin tid på bilagshåndtering. Og i snit håndteres hvert bilag 12,6 gange.',
    'Traditional Bookkeeper' => 'Traditional revisor',
    ...
    'ClickBooks gives you great value for your money. Not only do we offer the lowest bookkeeping rates in America. But on top of that our clients find that they are finally able to easily capture all of their receipts and thereby getting their full tax deductions.'=>'eRevisoren giver dig den bedste værdi for pengene. Ikke blot tilbyder vi de bedste bogføringspriser i Danmark. Men med eRevisorens revolutionerende koncept og app, sikrer vi at vores kunder lettere får inkluderet alle deres bilag, og dermed får fuldt fradrag for alle deres omkostninger.',
    'Top Notch Experienced Bookkeepers'=>'Kun erfarne og certificerede revisorer',
    'At ClickBooks we only use the best bookkeepers. Our bookkeepers are all certified seasoned professionals carefully selected, tested and trained in using the latest tools and technologies.'=>'Hos eRevisoren bruger vi kun erfarne og certificerede Revisorer. Vores revisorer er nøje udvalgte og har stor erfaring med små virksomheder. Alle er testet og trænet i brugen af de nyeste værktøjer og teknologi, og bliver løbende uddannet i de nyeste skatte- og bogføringsregler.',
    ...
    'With ClickBooks your time spent organizing your receipt and invoices have just been dramatically reduced. Not only the time you spend on organizing but also the time you spend worrying about it.'=>'Med eRevisoren er den tid du bruger på at organisere og opbevare dine bilag blevet kraftigt reduceret. Ikke bare den tid du bruger på at håndtere dine bilag, men også den tid du bruger på at bekymre dig om dine bilag.',
    'It\'s Incredibly Easy to Use'=>'Det er utroligt simpelt at bruge',
    'You\'ll never find a service that\'s easier to use than Clickbooks. Use our simple app to take pictures of your receipts and invoices and just let us take it from there. You\'re only 5 minutes away from being fully and finally out of the bookkeeping business.'=>'Du kommer ikke til at finde en service der er lettere at bruge end eRevisoren. Brug vores simple App til at tage billeder af dine bilag, og lad os klare den derfra. Du er kun 5 minutter væk fra at have forsimplet dit liv gevaldigt.',
    'It\'s Always With You'=>'Altid med dig',
    'With the ClickBooks App it\'s like always having your bookkeeper available and by your side. You never have to worry about managing and storing your invoices and receipts. You can always go to the personal Picture Archive online and print them.'=>'Med eRevisorens App er det som om du altid har din revisor med dig. Du behøver aldrig at skulle bekymre dig om at skulle gemme og opbevare dine bilag når du er på farten. Og når du har brug for at genfinde dine kvitteringer, går du bare ind på dit personlige bilagsarkiv online og finder dem frem.',
    
    'FAQ'=>'FAQ',
    'Top questions asked about ClickBooks'=>'Mest stillede spørgsmål til eRevisoren',
    'Does the monthly rate cover everything? Or are there any additional costs or fees involved with ClickBooks?'=>'Dækker månedsprisen alt?  Eller er der yderligere omkostninger ved at bruge eRevisoren?',
    'The monthly rate covers absolutely everything. There will never be any additional fees you\'ll have to pay. In fact, one of the benefits of using ClickBooks is you\'ll always know exactly what bookkeeping is costing your business.'=>'Den månedlige rate dækker alt, og du vil ikke få ekstra regninger for vores services. Faktisk er en af fordelene ved at bruge eRevisoren at du på forhånd ved præcis hvad din bogføring koster dig. ',
    ...
    'Can I switch to ClickBooks in the middle of the year?'=>'Kan jeg skifte over til eRevisoren midt i regnskabsåret?',
    ...
    'Will I get my own dedicated Bookkeeper?'=>'Får jeg min egen dedikerede Revisor?',
    'Yes you will. At ClickBooks all our customers have their own dedicated Bookkeeper.  This ensures that your ClickBooks bookkeeper will get to know your company and industry more intimately. It also makes it easier and more comfortable for you to ask questions without having to explain the nuances of your business each time.'=>'Ja, det gør du. Hos eRevisoren har alle vores kunder en dedikeret revisor. Det sikrer at din eRevisor revisor lærer din virksomhed og branche at kende mere intimt. Og det gør det også lettere og mere bekvemt for dig at stille spørgsmål til din revisor uden først at skulle forklare din virksomheds specifikke situation hver gang.',
    ...
    'What if I want to leave?'=>'Hvad hvis jeg gerne vil skifte væk fra eRevisoren?',
    'No problem. You will never be tied to ClickBooks longer than you want to. Just give us 30 days notice and we\'ll export your current books to a csv/excel format that can be utilized by your new bookkeeper.'=>'Ingen problemer. Du vil aldrig være bundet til eRevisoren længere end du ønsker det. Som en gratis service videregiver vi dine bogføringsdata til en anden revisor, hvis behovet opstår. Vi kan også eksportere dataene til et andet regnskabssystem for eksempel Dinero, E-conomic eller lignende.',
    ...
    'Online Archive of Receipts and Invoices'=>'1 times rådgivning fra vores erfarne revisorer <sup>2)</sup>',
    ...
    'ClickBooks accountants are certified by the following<br/>national associations of bookkeepers:'=>'eRevisorens revisorer er medlemmer af FFB',
    '&copy; Copyright {year}, ClickBooks. All Rights Reserved.'=>'&copy; Copyright {year}, eRevisoren. All Rights Reserved.',
    
    'ADDRESSES:'=>'ADRESSER:',
    'ClickBooks, LLC'=>'eRevisoren ApS',
    ...
    'Do you have any problems using ClickBooks, please don\'t hesitate to contact us. Our support teams are standing by to help you.'=>'Har du de mindste problemer med at bruge eRevisoren så giv os endelig besked. Vores Support Team står klar til at hjælpe dig.',
    'CUSTOMER SERVICE:'=>'KUNDESERVICE',
    'contact@myclickbooks.com'=>'kundeservice@erevisoren.dk',
    
    'No question is too small - We would love to hear from you'=>'Alle spørgsmål er velkomne -  Vi glæder os til at høre fra dig',
    
    'Login' => 'Log ind',
    
    'By Certified Bookkeepers'=>'Af FFB godkendte revisorer, fra kun ',
    'only $' => 'KR',
    '/ month'=>'/ måned',
