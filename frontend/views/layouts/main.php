...
$mainMenuItems = [
  ...
  ['label'       => Yii::t('app', 'Pricing'), 
   ...
   'linkOptions' => ['class'=>'external' . (Url::to(["site/pricing-plans"])==$_SERVER['REQUEST_URI']?' current':''), 'onclick' => "ga('send','event','Top Menu','Priser');" ] ],
  ['label'       => Yii::t('app', 'FAQ'), 
   'url'         => Yii::$app->homeUrl.'#faq'],
  ['label'       => Yii::t('app', 'Contact'), 
   'url'         => Url::to(["site/contact"]),
   'linkOptions' => ['class'=>'external' . (Url::to(["site/contact"])==$_SERVER['REQUEST_URI']?' current':''), 'onclick' => "ga('send','event','Top Menu','Kontakt');"] ],
  ['label'       => Yii::t('app', 'Free Trial'), 
   'url'         => "#",
   'linkOptions' => ['class' => 'signup-menu-item external', 'onclick' => "fbq('track', 'Lead'); fbq('track', 'InitiateCheckout'); ga('send','event','Top Menu','Prøv gratis');"] ],
  ['label'       => Yii::t('app', 'Call Me Back'), 
   'url'         => "#",
   'linkOptions' => ['class' => 'callmeback-menu-item external', 'onclick' => "fbq('track', 'Lead'); fbq('track', 'InitiateCheckout'); ga('send','event','Top Menu','Ring mig op');"] ],
...
$mainMenuItemsMobileVersion = [
  ...
  ['label'       => Yii::t('app', 'Pricing'), 
   'url'         => Url::to(["site/pricing-plans"]),
   'linkOptions' => ['class'=>'external', 'onclick' => "ga('send','event','Top Menu','Priser');"] ],
  ['label'       => Yii::t('app', 'Call Me Back'), 
   'url'         => "#",
...
$companyMenuItems = [
  ['label'       => Yii::t('app', 'Contact Us'), 
   'url'         => Url::to(["site/contact"])],
  ['label'       => Yii::t('app', 'Cookie Policy'), 
   'url'         => Url::to(["document/cookie-policy"])],
  ['label'       => Yii::t('app', 'Law'), 
   'url'         => Url::to(["document/law"])],
