    ...
    <div class="row">
        ...
        <div class="col-sm-7 col-sm-offset-2 col-md-7 col-md-offset-1 text-left lines">
            <ul class="list-unstyled text wow fadeInRight animated separator-line2">
                <li><big><i>“Den bedste investering som start-up”</i></big> <small>Henrik Thorsen, Solid Skiing</small></li>
                ...
                <li style="margin-left: 50px;"><big><i>”Vi er 110% tilfredse med eBogholderen”</i></big> <small>Tommy Madsen, Logmar Camera Solution</small></li>
            </ul>
        </div>
    </div>
</section>
