    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2">
                ...
                <p>Så snart du modtager et bilag, kan du med eRevisorens nye App tage et billede af det.<br/>
        Herefter bliver bilaget automatisk leveret til din revisor, som klarer resten. Og du sikrer dig at bilaget ikke bliver glemt eller mistet i den travle hverdag.</p>
                <ol>
                    <li>Tag et billlede af dit bilag</li>
                    <li>Billedet bliver automatisk sendt til og gemt hos eRevisoren</li>
                    <li>Den personlige revisor klarer resten</li>
                </ol>
                <p class="lead">eRevisorens App er gratis for alle vores kunder og kan downloades på Google play eller Apple App Store.</p>
                <p class="links">
