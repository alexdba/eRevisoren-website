  ...
  <div class="packages container">
    ...
    <div class="row">
      <div class="col-sm-12 text-center">
          ...
          <?= 
            Html::img(
              Url::to("@web/frontend/assets/images/home/price-light.jpg?v=1.3", true), 
          ...
          <?= 
            Html::img(
              Url::to("@web/frontend/assets/images/home/price-standard.jpg?v=1.3", true), 
          ...
          <?= 
            Html::img(
              Url::to("@web/frontend/assets/images/home/price-plus.jpg?v=1.3", true), 
