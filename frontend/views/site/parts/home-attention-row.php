      ...
      <div class="col-xs-12 col-md-12 intro attention-box">
        <div class="home-attention-row-subcontainer">
          <div class="attention-row-headings">
            <h4 class="fullscreen-page-heading">
              ...
              <div class="intro_sub_heading">
                <?= Yii::t('app', 'Prisgaranti - Danmarks billigste certificerede revisor'); ?>
              </div>
            </h4>
          ...
          <div class="attention-row-buttons">
              ...
              <a href="#" class="btn btn-primary btn-front-page" onclick="fbq('track', 'Lead'); fbq('track', 'InitiateCheckout');">
                <?= Yii::t('app', 'Start your FREE trial'); ?>
              </a>
              <a href="#" id="callme-button" class="btn" onclick="fbq('track', 'Lead'); fbq('track', 'InitiateCheckout');">
