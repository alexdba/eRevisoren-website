      ...
      <div class="col-xs-12 col-md-12 intro attention-box">
        <div class="home-attention-row-subcontainer">
          ...
          <div class="attention-row-buttons">
              ...
              <a href="#" class="btn btn-primary btn-front-page" onclick="fbq('track', 'Lead'); fbq('track', 'InitiateCheckout'); ga('send','event','Front Banner','Prøv gratis');">
                <?= Yii::t('app', 'Start your FREE trial'); ?>
              </a>
              <a href="#" id="callme-button" class="btn" onclick="fbq('track', 'Lead'); fbq('track', 'InitiateCheckout'); ga('send','event','Front Banner','Ring mig op');">
