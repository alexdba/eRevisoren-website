...
$this->title = Yii::t('app', 'Hos eRevisoren er prisen alt inklusive Men det er stadig dit ansvar');
...
<div class="document">
	<div class="section-header">
    	<h2 class="dark-text"><?= Yii::t('app', 'Hos eRevisoren er prisen alt inklusive <br/>Men det er stadig dit ansvar') ?></h2>
    </div>
