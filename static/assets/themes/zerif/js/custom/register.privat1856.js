...
$.vegas('slideshow', {
  delay:7000,
  backgrounds:[
    { src:config.assetsUrl+'themes/zerif/images/kontakt/background_privat.jpg', fade:1000 },
  ]
});
  ...
  $('#register-form').validate({
    rules: {
      ...
      email: {
        ...
        email: true,
        remote: {
          url: config.baseUrl+"register/checkexistemail",
          type: "post",
          data: {
            email: function() {
              return $( "#email" ).val();
    ...
    messages: {
        email: {
            remote: "E-mail-adresse allerede findes i systemet. VÃ¦lg et andet."
        }
    }
  });
